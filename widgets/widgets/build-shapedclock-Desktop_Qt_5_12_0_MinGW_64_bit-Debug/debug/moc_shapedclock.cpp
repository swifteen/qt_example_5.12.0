...
#include "../../shapedclock/shapedclock.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ShapedClock_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ShapedClock_t qt_meta_stringdata_ShapedClock = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ShapedClock"
...
QT_INIT_METAOBJECT const QMetaObject ShapedClock::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ShapedClock.data,
    qt_meta_data_ShapedClock,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ShapedClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShapedClock.stringdata0))
